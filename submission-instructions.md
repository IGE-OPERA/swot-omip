...
-----------------
The steps for submitting the required metadata are described below. An example of a metadata file is available [here](./Dataset_template/metadata_example_eORCA.yaml)
